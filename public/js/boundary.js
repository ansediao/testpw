...
const BOUNDARY_MARGIN = 50; // 边缘限制的宽度
function drawBoundary() {
    boundaryCtx.clearRect(0, 0, boundaryCanvas.width, boundaryCanvas.height);
    // 绘制半透明红色边框
    boundaryCtx.fillStyle = 'rgba(255, 0, 0, 1)';
    // 上边框
    boundaryCtx.fillRect(0, 0, boundaryCanvas.width, BOUNDARY_MARGIN);
    // 下边框
    boundaryCtx.fillRect(0, boundaryCanvas.height - BOUNDARY_MARGIN, boundaryCanvas.width, BOUNDARY_MARGIN);
    // 左边框
