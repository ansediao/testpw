...
<div class="content-area">
    ...
    <div id="content-sheji" class="content-pane">
        ...
        <style>
            ...
            .assign-btn:hover, .ungroup-btn:hover {
                background: #f3f4f6;
                border-color: #9ca3af;
            }
            ...
            .group-dialog .btn-primary {
                background: #3b82f6;
                color: #fff;
            }

            .group-dialog .btn-primary:hover {
                background: #2563eb;
            }

            .group-dialog .btn-secondary {
                background: #e5e7eb;
                color: #374151;
            }

            .group-dialog .btn-secondary:hover {
                background: #d1d5db;
            }
        </style>
