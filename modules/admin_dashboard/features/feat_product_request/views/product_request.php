...
<section class="pwca-admin-dashboard__pane pwca-admin-dashboard__pane--product-request">
	<h2 class="pwca-admin-dashboard__pane-title">Product Request</h2>
	...
	<div class="pwca-admin-dashboard__product-request">
		<p class="pwca-admin-dashboard__product-request-intro">We are passionate about new products and value every suggestion you provide. If you find an interesting product, please let us know!</p>
		...
		<form method="post" action="" enctype="multipart/form-data" id="pwca-product-request-form">
			...
			<p class="pwca-admin-dashboard__product-request-instruction">Just fill in any one field</p>

			<div class="pwca-admin-dashboard__form-field">
				<label for="pwca-product-description">Description</label>
				<textarea id="pwca-product-description" name="pw_product_description" rows="4"></textarea>
			</div>

			<div class="pwca-admin-dashboard__form-field">
				<label for="pwca-product-link">Product Link</label>
				<input type="url" id="pwca-product-link" name="pw_product_link">
			</div>

			<div class="pwca-admin-dashboard__form-field">
				<label for="pwca-product-image">Image</label>
