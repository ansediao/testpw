...
<div class="pwca-tabs-nav">
    <div id="tab-pinming" class="pwca-tab active">
        <img src="<?php echo PWCA_PLUGIN_URL  . 'assets/images/icons/product.svg'; ?>"
            alt="Product ICON">
        <div class="pwca-tab-title">Product</div>
    </div>
    <div id="tab-tuan" class="pwca-tab">
        <img src="<?php echo PWCA_PLUGIN_URL  . 'assets/images/icons/layers.svg'; ?>"
            alt="Layers ICON">
        <div class="pwca-tab-title">Layers</div>
    </div>
    <div id="tab-pianquan" class="pwca-tab">
        <img src="<?php echo PWCA_PLUGIN_URL  . 'assets/images/icons/image.svg'; ?>"
            alt="Image ICON">
        <div class="pwca-tab-title">Image</div>
    </div>
    <div id="tab-wenzi" class="pwca-tab">
        <img src="<?php echo PWCA_PLUGIN_URL  . 'assets/images/icons/text.svg'; ?>"
            alt="Text ICON">
        <div class="pwca-tab-title">Text</div>
    </div>
    <div id="tab-sheji" class="pwca-tab">
        <img src="<?php echo PWCA_PLUGIN_URL  . 'assets/images/icons/design.svg'; ?>"
            alt="Designs ICON">
